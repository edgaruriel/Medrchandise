			...
			<div id="div_contenido">
				<form id="formulario">
					<table>
						<tr>
							<td>Nombre:</td>
							<td><input type="text" id="nombre" value="Estetoscopio/Gasas"></td>
						</tr>
						<tr>
							<td> Descripci&oacute;n:</td>
							<td><TEXTAREA id="descripcion" cols="50" rows="5">Oferta imperdible</TEXTAREA></td>
						</tr>
						<tr>
							<td>Cantidad:</td>
							<td><input type="text" id="cantidad" value="3"></td>
						</tr>
						<tr>
							<td>Precio:</td>
							<td><input type="text" id="precio" value="$2000"></td>
						</tr>
						<tr>
							<td>Imagen: </td>
