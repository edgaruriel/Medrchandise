	...
	<div id=contenedor>
		...
		<div id="div_cuerpo">
			<div id="div_cuerpo_superior">
				<a href="agregarOferta.php" class="boton" id="btn_nuevaoferta">Nueva Oferta</a>
			</div>
			<div id="div_contenido">
				<table id="table_producto">
					...
					<tr>
						<td colspan="2" class="tabla_textocontenido">GASAS</td>
						<td class="tabla_textocontenido">$180.00</td>						
						<td class="tabla_textocontenido">
							 <ul >			
				  				<li class="accion"><a href="editaroferta.php"><img src="imagen/fotoeditar.jpg"></a></li>
